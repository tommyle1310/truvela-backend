...
import { CreateWeeklyStaffAvailabilityDto } from './create-weekly-staff-availability.dto';
import { IsString, IsArray, IsOptional, IsEnum, IsDateString } from 'class-validator';
import { Enum_WeekDays } from 'src/utils/enums';


export class UpdateWeeklyStaffAvailabilityDto extends PartialType(CreateWeeklyStaffAvailabilityDto) {
